package academy.microservicios.shopping.controller;
...
public class ShoppingController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<?> updateInvoice(@RequestBody Invoice invoice, @PathVariable("id")Long id){
    ...
    private String formatMessage(BindingResult result){
        ...
        return formatJsonString(errorMessage);
    }

    private String formatJsonString(ErrorMessage errorMessage){
